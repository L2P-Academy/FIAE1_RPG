...
public class EquipModel extends ItemModel {
	...
	public EquipModel(String itemName, int itemQuantity, double itemPrice, int itemDamage, int itemDefense, int requiredLevel, String itemDescription) {
	super(itemName, itemQuantity, itemPrice, itemDamage, itemDescription);
	this.itemDefense = itemDefense;
	this.requiredLevel = requiredLevel;
	}
