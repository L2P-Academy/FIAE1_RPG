...
//					nameChild.appendChild(document.createTextNode(currentItem.getName()));
//					itemRoot.appendChild(nameChild);
//					
//					//Adding price Child
//					if(currentItem.getValue() != 0) {
//						Element priceChild = document.createElement("Price");
//						priceChild.appendChild(document.createTextNode(String.valueOf(currentItem.getValue())));
...
//						int damage = Integer.parseInt(itemElement.getElementsByTagName("Damage").item(0).getTextContent());
////						ItemModel itemModel = new ItemModel<Enum<Type>>(i, itemName, quantity, null, i, isQuestItem, itemDescription, damage, damage);
////				    	itemList.add(itemModel);
//				    	
//					} 
//				}   
